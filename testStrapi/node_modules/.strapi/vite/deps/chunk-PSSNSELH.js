import {
  ...
  QueryClientProvider,
  img
} from "./chunk-RKO4BOCR.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-WRZDWTGU.js";
import {
  useAIAvailability,
  useNpsSurveySettings
} from "./chunk-FT3L2DHK.js";
import {
  useGetAIUsageQuery
} from "./chunk-WUCZOGOZ.js";
import {
  GuidedTourContext
} from "./chunk-PMOAE3MM.js";
import {
  require_pick
} from "./chunk-VCI4ZHLQ.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-QCSUIBLX.js";
import {
  useEnterprise
} from "./chunk-ESSRQHZI.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-DEPSTSDQ.js";
import {
  Login
} from "./chunk-EODUY5KM.js";
import {
  MemoizedInputRenderer
} from "./chunk-S7NGXQB4.js";
import {
  Form
} from "./chunk-2GAA65BV.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-KCH2J2JH.js";
import {
  ConfigurationProvider
} from "./chunk-STPCI2VC.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-GOCXJSG5.js";
import {
  require_baseRest
} from "./chunk-F2U3ELYS.js";
import {
  HistoryProvider
} from "./chunk-EYKV5VT6.js";
import {
  errorsTrads
...
} from "./chunk-BRC7J3UG.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-FFHFTD5C.js";
import {
...
var App = ({ strapi, store }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Providers, {
    strapi,
    store,
    children: (0, import_jsx_runtime4.jsxs)(import_react5.Suspense, {
      fallback: (0, import_jsx_runtime4.jsx)(Page.Loading, {}),
      children: [
        (0, import_jsx_runtime4.jsx)(GlobalNotifications, {}),
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-2HLPYTDW.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-VMNYQIM4.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-ZH7Z5L7M.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-UC7MANAF.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MSTB5ID2.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-3IT6CI6R.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-46FJWWTO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GNRCDF6V.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-5DBQEIKD.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-BDOPD7ZI.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-6FBS6H7O.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-JWXU4J6W.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-SMHRHP4O.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-V6SDBGLJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-5UXUQJCW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-KJJYFSBH.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-L25HPH4J.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-RIS4V55H.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-NGBNGVOM.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-6AF6WDTN.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-3ONFVJ5H.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-OCT45NSG.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-4UA4PIWL.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-MBG6VNTH.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-AWHW2MWO.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-RQUB4JAI.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-AWXRZ7W2.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-QW4XMWJX.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-AWPJN7MA.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-77OZUL5X.js");
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-VDFLVRRO.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-ITF5VJ4B.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-ITF5VJ4B.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-SBNDQE27.js");
...
//# sourceMappingURL=chunk-PSSNSELH.js.map
