import {
  reducer
} from "./chunk-2X5VPZ2P.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-DWVXJ2PU.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-7474QJYZ.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-MTW2ZOBP.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-MTW2ZOBP.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-MTW2ZOBP.js");
...
//# sourceMappingURL=chunk-CGTIFESD.js.map
