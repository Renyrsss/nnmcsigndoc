...
const SignPage = () => {
    ...
    // Для отладки - проверяем что currentDocument есть
    console.log("currentDocument:", currentDocument);
    console.log("currentDocument.attributes:", currentDocument?.attributes);
    ...
    const handleSubmit = useCallback(async () => {
        ...
        try {
            ...
            // Для отладки
            console.log("Generating PDF with documentData:", currentDocument);

            // Генерируем PDF с данными документа из Strapi
            ...
            await telegramService.sendNotification({
                ...
                documentTitle:
                    currentDocument?.attributes?.title ||
